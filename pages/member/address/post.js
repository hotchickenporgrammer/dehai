...
Page({
  ...
  getDetail: function () {
    ...
    e.get("member/address/get_detail", {
      ...
      var a = {
        ...
        show: !0,
        isuserid: e.isuserid,
        imgs: e.detail.justthumb,
        imgs1: e.detail.backthumb,
      };
      } else {
        var a = {
          openstreet: e.openstreet,
  ...
  submit: function () {
    ...
    if (!t.data.posting) {
      ...
      if (t.data.isuserid=='1'){
        if ("" == i.userid || !i.userid) return void a.toast(t, "请填写身份证号");
        if ("" == t.data.imgs || !t.data.imgs) return void a.toast(t, "请上传正面身份证图片");
        if ("" == t.data.imgs1 || !t.data.imgs1) return void a.toast(t, "请上传反面身份证图片");
      }
      if ("" == i.mobile || !i.mobile||i.mobile.length!=11) return void a.toast(t, "请确认联系电话");
  ...
  upload: function (t) {
    var m = this,
      ...
      o = m.data.imgs,
      r = i.index;
    console.log(m.data.imgs)
    "image" == s ? e.upload(function (t) {
      m.setData({
        images: t.filename,
        imgs: t.url,
        'detail.justthumb': t.url
      })
    }) : "image-remove" == s ? ( m.setData({
        images: '',
        imgs: '',
        'detail.justthumb': ''
